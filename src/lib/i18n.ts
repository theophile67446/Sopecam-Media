...
const MESSAGES = {
  fr: {
    ...
    shopOverline: 'Le kiosque numérique',
    shopFeature1: 'Lecture immédiate après paiement',
    shopFeature2: 'MTN Mobile Money & Orange Money',
    shopFeature3: 'Archives et anciens numéros',
    shopPrice: 'Édition du jour dès 400 FCFA',
    shopTodayBadge: 'Édition du jour',
    regionsTitle: 'Régions',
    regionsOverline: 'Le Cameroun des correspondants',
    regionsTagline: 'Toute l\'information venue des dix régions du Cameroun, par nos correspondants locaux. Choisissez une région pour explorer ses actualités.',
    regionsLatest: 'Dernières correspondances',
    regionsBrowseAll: 'Toute l\'actualité régionale',
    regionsArticles: 'articles',
  ...
  en: {
    ...
    shopOverline: 'The digital newsstand',
    shopFeature1: 'Read instantly after payment',
    shopFeature2: 'MTN Mobile Money & Orange Money',
    shopFeature3: 'Archives and back issues',
    shopPrice: 'Today\'s edition from 400 FCFA',
    shopTodayBadge: 'Today\'s edition',
    regionsTitle: 'Regions',
    regionsOverline: 'Cameroon through our correspondents',
    regionsTagline: 'News from all ten regions of Cameroon, reported by our local correspondents. Pick a region to explore its stories.',
    regionsLatest: 'Latest regional reports',
    regionsBrowseAll: 'All regional news',
    regionsArticles: 'articles',
